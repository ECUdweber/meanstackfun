...
var ApplicationConfiguration = (function() {
	...
	var applicationModuleVendorDependencies = ['ngResource', 'ngCookies',  'ngAnimate',  'ngTouch',  'ngSanitize',  'ui.router', 'ui.bootstrap', 'ui.utils', 'ui.timepicker'];
...
angular.module('recipes').controller('RecipesController', ['$scope', '$stateParams', '$location', 'Authentication', 'Recipes',
	function($scope, $stateParams, $location, Authentication, Recipes) {
		...
		$scope.title = 'TESTING DIRECTIVE';
		$scope.subtitle = 'I am an app';
...
/*
console.log('Has anyone seen jquery?');
...
angular.module('recipes').directive('testScopedDirective', [
	function() {
		return {
			scope: false, // Not necessary since false is default. But experimenting, so leaving here to allow changing to true or {}
			/*
			scope: {
				'title' : '@msdTitle',
			...
			*/
			...
			link: function ($scope, $element, $attrs) {
				...
				$scope.setDirectiveSubtitle = function (subtitle) {
					console.log('Setting subtitle..: ', subtitle);
					$scope.subtitle = subtitle;
				};				
			}
			/*
			link: function postLink(scope, element, attrs) {
				// Test scoped directive directive logic
				element.text('this is the testScopedDirective directive');
			}
			*/
		};
	}
...
angular.module('recipes').directive('timePicker', [
	function() {
		return {
			scope: false, // Not necessary since false is default. But experimenting, so leaving here to allow changing to true or {}
			/*
